...
export default function Infrastructure() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
      {/* Enhanced Hero Section with Blue-Red Styling */}
      <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-red-900">
        ...
        <div className="relative px-6 py-24 mx-auto max-w-7xl sm:py-32 lg:px-8">
          <div className={`text-center transition-all duration-1000 transform ${
            ...
            <h1 className="text-4xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-red-400 sm:text-6xl lg:text-7xl">
              Infrastructure
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <div className="w-32 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent animate-pulse"></div>
        </div>
      </div>
